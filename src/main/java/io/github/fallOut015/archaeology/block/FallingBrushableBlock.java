...
public class FallingBrushableBlock extends FallingBlock implements IBrushableBlock {
    final BlockState normal;

    public FallingBrushableBlock(final BlockState normal, Properties properties) {
        super(properties);
